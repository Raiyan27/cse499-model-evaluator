...
# Prompts import
from prompts import (SYS_INITIAL_QUERY_PROMPT, SYS_WEB_SEARCH_PROMPT, SYS_PROMPT_GRADER, SYS_PROMPT_RAG, CONVERSATION_QUERY_ASSESMENT_PROMPT)
...
def assess_clarity_node(state: ClarificationState, assessment_llm: ChatOpenAI):
    ...
    ASSESSMENT_PROMPT = ChatPromptTemplate.from_messages([
        ("system", CONVERSATION_QUERY_ASSESMENT_PROMPT),
